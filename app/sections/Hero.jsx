  ...
  return (
    <section>
      <div className='relative '>
        <div className='w-full  '><Image src={bulb} alt="" className='h-[700px]' /></div>
        <div className='section absolute inset-0 flex gap-5 flex-col items-center justify-center text-center text-white '>
          <p className='text-5xl  font-bold'>Where <br /> <span className='text-yellow-400'>Innovation</span>  <br /> Comes to <span className='text-yellow-400'>Life</span> </p>
